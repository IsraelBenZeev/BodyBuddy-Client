...
return (
  <BackGround>
    <ScrollView className="flex-1 px-5 py-8">
      <Text className="text-lime-400 text-3xl font-black mb-2 text-right">תזונה</Text>

      {motivationMessage && (
        <View className="bg-lime-500/10 border border-lime-500/30 rounded-2xl p-4 mb-6">
          <Text className="text-lime-400 text-center font-bold">{motivationMessage}</Text>
        </View>
      )}
      ...
      <MacroPieChart macroSplit={macroSplit} />
